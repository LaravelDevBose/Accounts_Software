                    ...
                    <div class="tab-content no-border padding-24">
                        ...
                        <div id="order" class="tab-pane in active">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="<?= base_url()?>ready/car/purchase/<?= $order->id ?>" class="btn btn-xs btn-block btn-success">
                                        <i class="ace-icon fa fa-cart-plus  bigger-110"></i>
                        ...
                        <div id="purchase" class="tab-pane <?= (isset($order) && $order)?'': 'in active'?> ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <a href="<?= base_url()?>ready/car/order/<?= $purchase->id?>" class="btn btn-xs btn-block btn-success">
                                            <i class="ace-icon fa fa-cart-plus  bigger-110"></i>
                                ...
                                <div class="col-md-2">
                                    <a href="#" class="btn btn-xs btn-block btn-info">
                                        <i class="ace-icon fa fa-money  bigger-110"></i>
                                        <span class="bigger-110"> <?= (isset($price) && $price)?'Add':'Update' ?> Purchase Pricing</span>
                                    </a>
                                </div>
                            </div>
                            <div class="space-4"></div>
                                            ...
                                            <div class="widget-main">
                                                <div class="profile-user-info profile-user-info-striped">
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="username"><?= number_format($price->lc_value, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="username"><?= number_format($price->obc_value, 2)?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->insurance_charge, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->final_dosis, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->custom_value, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->cf_agent, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->cuharf_value, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="username"><?= number_format($price->s_charge, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="username"><?= number_format($price->regi_charge, 2)?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->first_party_insu, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->third_party_insu, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->workshop_bill, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->decuration_bill, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="country"><?= number_format($price->other_exp, 2)?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        <div class="profile-info-name">Total Amount: </div>
