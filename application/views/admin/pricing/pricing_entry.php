                                ...
                                <div class="col-sm-7">
                                    <select class="chosen-select form-control" id="car_pus_id" style="height: 30px; border-radius: 5px;">
                                        <?php if(isset($purchase) && $purchase):?>
                                            <option value="<?= $purchase->id?>" selected><?= $purchase->pus_sl.'-'.$purchase->puc_chassis_no; ?></option>

                                        <?php else:
                                            echo '<option value=" ">Select a Purchase No</option>';
                                            if(isset($purchases) && $purchases):  foreach($purchases as $pus):?>
                                            <option value="<?= $pus->id; ?>"  ><?= $pus->pus_sl.'-'.$pus->puc_chassis_no; ?></option>
