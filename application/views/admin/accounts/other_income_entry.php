  ...
  <div class="col-xs-12">
      ...
      <div class="widget-box">
        <div class="widget-header">
          <h4 class="widget-title">Add New Other Income</h4>
            ...
            <form id="other_income" >
              <div class="row">
                <div class="col-sm-2">
                  ...
                  <input type="hidden" name="account_type" value="other_income">
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="widget-box">
      <div class="widget-header">
        <h4 class="widget-title">Other Income Information List</h4>
        <div class="widget-toolbar">
          <a href="#" data-action="collapse">
            <i class="ace-icon fa fa-chevron-up"></i>
          </a>
