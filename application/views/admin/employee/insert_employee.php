<div class="row">
  <div class="col-xs-12">
    <form id="CusOrderForm" method="post" action="<?= base_url('employee/store'); ?>">  

      <!--============Customer Information============ -->
      <!--============Customer Information============ -->
      <div class="widget-box">
        <div class="widget-header">
          <h4 class="widget-title">Add New Employee Information</h4>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" id="emp_name" required name="emp_name" placeholder="Employee Name" class="form-control"  />
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-5 control-label no-padding-left" for="emp_dob"> Date of Birth:<span class="text-bold text-danger">*</span> </label>
                  <div class="col-sm-7">
                     <input class="form-control date-picker" required id="emp_dob" name="emp_dob" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" id="emp_nid" name="emp_nid" required placeholder="Employee NID" class="form-control" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" id="emp_phone" name="emp_phone" required placeholder="Contact No" class="form-control" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="email" id="emp_email" name="emp_email" placeholder="Email Address" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                     <input class="form-control date-picker" required id="emp_join_date" name="emp_join_date" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label no-padding-left" for="emp_sallary"> Sallary:<span class="text-bold text-danger">*</span> </label>
                  <div class="col-sm-7">
                    <input type="number" id="emp_sallary" required name="emp_sallary" placeholder="Sallary" class="form-control" />
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea id="pre_address" required name="pre_address" placeholder="Present Address" class="form-control" ></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea id="par_address"  name="par_address" placeholder="Parmanent Address" class="form-control" ></textarea>
                  </div>
                </div>
