...
class AdminAccess extends MY_Controller
{
    ...
    {	
        ...
        $attr = array(
            ...
            'ready_car_sale'            => ( $this->input->post('ready_car_sale'))?1:0,
            ...
            'pricing_entry'         	=> ( $this->input->post('pricing_entry'))?1:0,
            'pricing_list'         	    => ( $this->input->post('pricing_list'))?1:0,
            ...
            'bank_trans'           	    => ( $this->input->post('bank_trans'))?1:0,
            'balance_sheet'           	=> ( $this->input->post('balance_sheet'))?1:0,
            ...
            'lc_info'            		=> ( $this->input->post('lc_info'))?1:0,
            'lc_entry'            		=> ( $this->input->post('lc_entry'))?1:0,
            'lc_list'            		=> ( $this->input->post('lc_list'))?1:0,
